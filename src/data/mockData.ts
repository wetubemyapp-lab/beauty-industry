...
export const SUPPLIERS: SupplierPartner[] = [
  ...
  },
  {
    ...
    minOrderValue: 250,
    description: 'Exclusive regional distributor for international hair color brands and premium styling equipment. Next-day delivery available across North India.',
    email: 'contact@luxecolordist.in',
  ...
  },
  {
    ...
    minOrderValue: 500,
    description: 'Premier European distributor of salon-grade professional treatments and patented ionic styling gear.',
    email: 'wholesale@luxe-elite.fr',
  ...
  },
  {
    ...
    responseRate: '99% within 1h',
    minOrderValue: 800,
    description: 'FDA-certified beauty lab manufacturing high-potency active peptides, medical-grade lash kits, and pigments.',
    email: 'orders@globalglamour.com',
  ...
  },
  {
    ...
    minOrderValue: 350,
    description: 'Direct importer of organic Nordic clays, Himalayan salt spa stones, and hydrotherapy equipment.',
    email: 'contact@purebeautyimports.co.uk',
  ...
  },
  {
    ...
    minOrderValue: 1000,
    description: 'Italian formulation house specializing in ammonia-free micro-pigments and bio-fermented hyaluronic serums.',
    email: 'export@milanocosmetica.it',
    phone: '+39 02 8739 4410',
    whatsapp: '+390287394410',
    establishedYear: 2015,
  ...
  },
  {
    ...
    minOrderValue: 1200,
    description: 'Bespoke wellness equipment and 24K gold luxury ritual lines for 5-star resort spas and aesthetic clinics.',
    email: 'b2b@dubaispaatelier.ae',
...
export const PRODUCTS: Product[] = [
  {
    ...
    leadTimeDays: 3,
    certifications: ['CE Certified', 'UL Listed', 'RoHS Compliance'],
    supplierId: 'le-dist',
    supplierName: 'Luxe Elite Distribution',
    supplierLocation: 'Paris, EU',
    rating: 4.8,
    reviewsCount: 64,
    wholesaleTiers: [
      { minUnits: 10, pricePerUnit: 145.00 },
      { minUnits: 25, pricePerUnit: 132.00 },
      { minUnits: 50, pricePerUnit: 118.00 },
      { minUnits: 100, pricePerUnit: 99.00 }
    ]
  },
  {
    ...
    supplierName: 'Global Glamour Supply',
    supplierLocation: 'New York, NA',
    rating: 4.9,
    reviewsCount: 128,
    wholesaleTiers: [
      { minUnits: 50, pricePerUnit: 28.50 },
      { minUnits: 150, pricePerUnit: 24.00 },
      { minUnits: 500, pricePerUnit: 19.50 },
      { minUnits: 1000, pricePerUnit: 16.00 }
    ]
  },
  {
    id: 'prod-brush-set',
    ...
    reviewsCount: 45,
    wholesaleTiers: [
      { minUnits: 20, pricePerUnit: 45.00 },
      { minUnits: 50, pricePerUnit: 38.00 },
      { minUnits: 100, pricePerUnit: 32.00 }
    ]
  },
  {
    ...
    specifications: {
      ...
      'Origin': 'Formulated in Geneva, Switzerland'
    },
    leadTimeDays: 2,
    certifications: ['Swiss Made Standard', 'Ecocert', 'Dermatest 5-Star'],
    supplierId: 'le-dist',
    supplierName: 'Luxe Elite Distribution',
    supplierLocation: 'Paris, EU',
    rating: 5.0,
    reviewsCount: 82,
    wholesaleTiers: [
      { minUnits: 15, pricePerUnit: 64.00 },
      { minUnits: 40, pricePerUnit: 54.00 },
      { minUnits: 100, pricePerUnit: 46.00 }
    ]
  },
  {
    ...
    leadTimeDays: 4,
    certifications: ['EU Cosmetics Compliant', 'Eco-Certified Extracts'],
    supplierId: 'mc-milano',
    supplierName: 'Milano Cosmetica Pro',
    supplierLocation: 'Milan, EU',
    rating: 4.9,
    reviewsCount: 110,
    wholesaleTiers: [
      { minUnits: 60, pricePerUnit: 8.90 },
      { minUnits: 200, pricePerUnit: 7.20 },
      { minUnits: 500, pricePerUnit: 6.10 }
    ]
  },
  {
    id: 'prod-spa-bed',
    ...
    description: 'Triple-motor whisper-quiet medical massage and facial recliner with built-in heated memory foam mattress and antimicrobial Italian PU leather.',
    specifications: {
      'Motors': '3 German OKIN Precision Actuators',
    ...
    supplierId: 'td-dubai',
    supplierName: 'The Dubai Spa Atelier',
    supplierLocation: 'Dubai, UAE',
    rating: 4.9,
    reviewsCount: 38,
    wholesaleTiers: [
      { minUnits: 2, pricePerUnit: 890.00 },
      { minUnits: 5, pricePerUnit: 780.00 },
      { minUnits: 10, pricePerUnit: 690.00 }
    ]
  },
  {
    ...
    reviewsCount: 94,
    wholesaleTiers: [
      { minUnits: 30, pricePerUnit: 34.00 },
      { minUnits: 100, pricePerUnit: 29.00 },
      { minUnits: 300, pricePerUnit: 23.50 }
    ]
  },
  {
    ...
    reviewsCount: 52,
    wholesaleTiers: [
      { minUnits: 5, pricePerUnit: 189.00 },
      { minUnits: 15, pricePerUnit: 168.00 },
      { minUnits: 50, pricePerUnit: 145.00 }
    ]
  }
];
...
export const MOCK_VIDEO_TESTIMONIALS: import('../types').VideoTestimonial[] = [
  {
    ...
    distributorName: 'Luxe Elite Distribution',
    distributorLocation: 'Paris, EU',
    distributorInitials: 'LE',
    distributorVerified: true,
    speakerName: 'Jean-Luc Moreau',
    speakerRole: 'Artistic Director & Master Stylist',
    salonOrBusiness: 'Salon Champs-Élysées Paris',
  ...
  },
  {
    ...
    distributorName: 'Milano Cosmetica Pro',
    distributorLocation: 'Milan, EU',
    distributorInitials: 'MC',
    distributorVerified: true,
    speakerName: 'Dr. Alessandra Conti',
    speakerRole: 'Lead Formulation Chemist & R&D Head',
    salonOrBusiness: 'Milano Dermocosmetic Laboratories',
    ...
    featuredProductPrice: 32.5,
    featuredProductMoq: 25,
    category: 'Skincare',
    ...
    quote: 'Our European partner clinics rely on this formulation post-laser and for pre-event luxury hydra-facials without any tacky residue.',
    date: 'July 2026'
  },
  {
    id: 'vid-3',
    ...
    distributorName: 'The Dubai Spa Atelier',
    distributorLocation: 'Dubai, UAE',
    distributorInitials: 'TD',
    distributorVerified: true,
    ...
    featuredProductPrice: 68.0,
    featuredProductMoq: 12,
    ...
    quote: 'Distributing this luxury line to over 40 luxury resorts across Dubai and Riyadh has transformed our partners VIP menu offerings.',
    date: 'June 2026'
  },
  {
    id: 'vid-4',
    ...
    distributorName: 'Global Glamour Supply',
    distributorLocation: 'New York, NA',
    distributorInitials: 'GG',
    distributorVerified: true,
    speakerName: 'Elena Rostova',
    speakerRole: 'Chief Esthetician & Product Evangelist',
    salonOrBusiness: 'Manhattan Glow MediSpa',
  ...
  {
    id: 'vid-5',
    title: 'Nordic Clay & Thermal Scalp Treatment Line Unboxing & Application',
    distributorId: 'pb-imports',
    distributorName: 'Pure Beauty Imports',
    distributorLocation: 'London, UK',
    distributorInitials: 'PB',
    ...
    featuredProductPrice: 24.0,
    featuredProductMoq: 20,
    category: 'Haircare & Spa',
    tags: ['Organic Nordic Clay', 'Scalp Health', 'Eco-Certified'],
    keyHighlight: '100% pure unrefined glacial silt rich in 60+ trace minerals for follicle rejuvenation.',
    quote: 'Eco-conscious salons across the UK have made this their #1 scalp therapy upgrade for high-end clientele.',
    date: 'May 2026'
  }
];
